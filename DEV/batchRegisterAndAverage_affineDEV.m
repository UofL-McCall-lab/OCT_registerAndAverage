...
%
%   - Unless you have > 16GB RAM, use no more than 4 CPU cores (assuming 8
%     available cores).
%
...
clear
%% INPUTS/CONTROLS
inputPath = 'C:\Users\dalst\Desktop\Mouse Unaveraged b-scans 11-16-23\Stack 50\OCTA den testing\50 Raw - denoised by model trained on OCTA sq diff'; % Folder with just input raw images and nothing else
outPath = 'C:\Users\dalst\Desktop\Mouse Unaveraged b-scans 11-16-23\Stack 50\OCTA den testing\50 Raw - denoised by model trained on OCTA sq diff - autoreg 5 translation';  % Empty folder for output
