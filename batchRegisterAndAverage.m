...
clear
%% INPUTS/CONTROLS
inputPath = 'C:\C_WorkLocal\McCall Lab\OCT\Willie example OCT\Raw b scans'; % Folder with just input raw images and nothing else
outPath = 'C:\C_WorkLocal\McCall Lab\OCT\Willie example OCT\reg-AVG';  % Empty folder for output
